...
// Allocate Transform Message Class
          ...
          igtl::PointMessage::Pointer pointMsgS;
          pointMsgS = igtl::PointMessage::New();
          pointMsgS->SetDeviceName("PointSender");
          ...
          point2->SetName(pointElement->GetName());
          point2->SetGroupName(pointElement->GetGroupName());
          point2->SetRGBA(rgba);
          point2->SetPosition(pos2);
          point2->SetRadius(pointElement->GetRadius());
          point2->SetOwner(pointElement->GetOwner());


          pointMsgS->AddPointElement(point2);
          igtl::Sleep(1000);
          pointMsgS->Pack();
          socket->Send(pointMsgS->GetPackPointer(), pointMsgS->GetPackSize());
      }
